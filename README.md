...
3.7 and 3.8](https://www.python.org/downloads). Unfortunately, SDV **is not fully supported on Windows
OSs**, but it is know to run successfully on [WSL](https://docs.microsoft.com/en-us/windows/wsl/install-win10).
