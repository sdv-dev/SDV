...
def test_conditional_sampling_graceful_reject_sampling_True_dict():
    data = pd.DataFrame({
...
def test_conditional_sampling_graceful_reject_sampling_True_dataframe():
    data = pd.DataFrame({
        "column1": list(range(100)),
        "column2": list(range(100)),
        "column3": list(range(100))
...
def test_conditional_sampling_graceful_reject_sampling_False_dict():
    data = pd.DataFrame({
        "column1": list(range(100)),
        "column2": list(range(100)),
        "column3": list(range(100))
...
def test_conditional_sampling_graceful_reject_sampling_False_dataframe():
    data = pd.DataFrame({
        "column1": list(range(100)),
        "column2": list(range(100)),
        "column3": list(range(100))
