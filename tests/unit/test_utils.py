...
@patch('sdv.utils.pkg_resources.get_distribution')
def test_generate_version_mismatch_warning_no_mismatches(get_distribution_mock):
    ...
    # Run
    out = generate_version_mismatch_warning(package_versions)
...
def test_generate_version_mismatch_warning_mismatched_version(get_distribution_mock):
    ...
    Expect that the proper warning string is returned.
...
def test_generate_version_mismatch_warning_mismatched_version_error(get_distribution_mock):
    ...
    package, we treat that as a mismatch and the proper warning string is returned.
