...
@patch('sdv.utils.utils._get_total_estimated_columns')
@patch('sdv.utils.utils._print_simplified_schema_summary')
...
@patch('sdv.utils.utils._simplify_metadata')
@patch('sdv.utils.utils._simplify_data')
@patch('sdv.utils.utils._get_total_estimated_columns')
@patch('sdv.utils.utils._print_simplified_schema_summary')
...
@patch('sdv.utils.utils._subsample_data')
@patch('sdv.utils.utils._print_subsample_summary')
